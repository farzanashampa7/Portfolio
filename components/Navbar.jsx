...
const Navbar = () => {
  ...
  // const [linkColor, setLinkColor] = useState('#1f3937')
  ...
  return (
    <div
      className={
        shadow
          ? 'fixed w-full h-20 shadow-xl z-[1000] bg-[#ecf0f3]'
          : 'fixed w-full h-20 z-[1000] bg-[#ecf0f3]'
      }
    >
      <div className="flex justify-end items-center w-full h-full px-2 2xl:px-16">
        {/* <Link href="/">
          <Image src="/assets/skills/css.png" alt="" width="100" height="50" />
        </Link> */}
        <div>
